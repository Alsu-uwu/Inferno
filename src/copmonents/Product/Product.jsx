        ...
        <div className="product">
            <div className="product-img">
                ...
                <div className="product-actions" style={styles} onMouseEnter={()=> setHover(true)}>
                    <Button color="black" bgcolor="white" hovercolor="white" hoverbgcolor="rgb(255, 0, 98)">В корозину</Button>
                    <button onClick={handleButtonClick} style={{backgroundColor: isLiked ? "rgb(255, 0, 98)" : "white"}}  className="heartbtn"><img src={heartsvg} alt="Like" /></button>
                </div>
            </div>
